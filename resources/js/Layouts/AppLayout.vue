...
import SideMenu from '@/Components/MyComponents/SideMenu.vue';
...
<template>
    <div>
        ...
        <div class="overflow-y-hidden h-screen bg-gray-200 lg:grid lg:grid-cols-6 dark:bg-gray-900">
            <!-- Page Heading
                ...
                <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                        ...
                        <div class="pt-2 pb-3 space-y-1">
                            <ResponsiveNavLink v-for="(menu, index) in menus" :key="index" :href="route(menu.route)"
